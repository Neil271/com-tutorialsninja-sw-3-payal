...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-payment-firstname']"),"Payal");
        sendTextOnElement(By.xpath("//input[@id='input-payment-lastname']"),"Patel");
        sendTextOnElement(By.xpath("//input[@id='input-payment-email']"),"Payal23@gmail.com");
        sendTextOnElement(By.xpath("//input[@id='input-payment-telephone']"),"2323232323");
        sendTextOnElement(By.xpath("//input[@id='input-payment-address-1']"),"234D, Edgware");
        sendTextOnElement(By.xpath("//input[@id='input-payment-city']"),"London");
        sendTextOnElement(By.xpath("//input[@id='input-payment-postcode']"),"HA4 4OO");
