...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-firstname']"), "Payal");

        //Enter the Last Name
        sendTextOnElement(By.xpath("//input[@id='input-lastname']"), "Patel");

        //Enter the Email
        sendTextOnElement(By.xpath("//input[@id='input-email']"), "Payal567@gmail.com");
        //Enter the Telephone
        sendTextOnElement(By.xpath("//input[@id='input-telephone']"), "2323232323");
        //3.7 Enter the Password
        sendTextOnElement(By.xpath("//input[@id='input-password']"), "Payal123@");

        //3.8 Enter the Password Confirm
        sendTextOnElement(By.xpath("//input[@id='input-confirm']"), "Payal123@");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextOnElement(By.xpath("//input[@id='input-email']"), "Payal4567@gmail.com");
